...
- They give the user access for certain amount of time so they do not have log in everytime they make a request.

2. What does bcrypt do to help us store passwords in a secure manner.

- bcrypt hashes passwords for us in the database. They generate a unique hash for each individual password.

3. What does bcrypt do to slow down attackers?

- bcrypt forces attackers to decode a hashed password. This is very difficult to do and can be even harder depending on the strength of the password.
